...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore-99xp'), require('validate-99xp'), require('backbone-request-99xp'), require('app-exception')) :
    typeof define === 'function' && define.amd ? define(['exports', 'underscore-99xp', 'validate-99xp', 'backbone-request-99xp', 'app-exception'], factory) :
    (global = global || self, factory(global.BackboneApi = {}, global._, global.v, global.BackboneRequest, global.AppException));
}(this, function (exports, _, v, BackboneRequest, AppException) { 'use strict';
