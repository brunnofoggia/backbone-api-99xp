...
var extended = {
  ...
  callApi(method, methodData, success, error) {
    ...
    var beforeError = _.bind(_.partial(function (data, o, body, methodData, e) {
      var _data$response;

      typeof error === 'function' ? _.bind(error, this)(data, o, body, methodData) : BackboneApi.error(data === null || data === void 0 ? void 0 : data.error, 0, (data === null || data === void 0 ? void 0 : (_data$response = data.response) === null || _data$response === void 0 ? void 0 : _data$response.statusCode) || 500);
    }, data, o, this._req.body, methodData), this),
    ...
    request = _.bind(_.partial((_method, _methodData, _success, _error, _o) => {
      ...
      this.once(['sync', _.bind(() => {
        ...
        try {
          ...
          typeof _error === 'function' ? _.bind(_error, this)(data, _o, this._req.body, _methodData) : BackboneApi.error(data === null || data === void 0 ? void 0 : data.error, 0, (data === null || data === void 0 ? void 0 : (_data$response2 = data.response) === null || _data$response2 === void 0 ? void 0 : _data$response2.statusCode) || 500);
        } catch (e) {
